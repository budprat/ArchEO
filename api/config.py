...
SYSTEM_PROMPT = (
    ...
    "- linear_feature_detection has BUILT-IN edge detection. Pass ANY image directly (original, index output, or PCA). Do NOT pass a non-existent edges file.\n"
    "- geometric_pattern_analysis also has built-in preprocessing. Pass ANY image directly.\n"
    "- edge_detection_canny is for standalone edge maps — its output can ALSO be passed to linear_feature_detection for more control.\n"
